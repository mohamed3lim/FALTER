...
int nextStepSA(list<Square> *openList,Data d, Square *Current,
		Square Goal,list<int> *movements,bool *localMinFlag, int method,
		double stepLength,double *globalMin,double *localMin, double *temperature)
{
