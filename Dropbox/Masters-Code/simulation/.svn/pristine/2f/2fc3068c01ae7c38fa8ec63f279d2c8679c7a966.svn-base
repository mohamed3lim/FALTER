...
#define S_FUNCTION_NAME  falter_particle_sfunction
#define S_FUNCTION_LEVEL 2

/* This macro is needed for correctly including falter_sharedmemory_sfunction.h */
#define PARTICLE_S_FUNCTION
 ...
 */
#include "simstruc.h"
#include "variables_particle.h"
#include "falter_sharedMemory_sfunction.h"

extern int particle_init();
extern void particle_step();
...
{
    ssSetSampleTime(S, 0, PARTICLE_SAMPLE_TIME);
