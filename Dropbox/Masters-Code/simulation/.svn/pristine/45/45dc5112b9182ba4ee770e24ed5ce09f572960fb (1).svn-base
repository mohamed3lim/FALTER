...
#define S_FUNCTION_NAME  falter_flightmanagement_sfunction
 ...
 */
#include "simstruc.h"
#include "variables_flightmanagement.h"
#include "falter_sharedMemory_sfunction.h"

extern void flightMonitoring_init();
extern void flightMonitoring();
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    /* errors */
    ssSetInputPortWidth(S, INPUT_CTRL_REF, 2);
    ssSetInputPortDataType(S, INPUT_CTRL_REF, SS_UINT32);
    
    /*ssSetInputPortMatrixDimensions(S, INPUT_HEATMAP, 270, 160);
    ssSetInputPortDirectFeedThrough(S, INPUT_HEATMAP, 1);
    ssSetInputPortRequiredContiguous(S, INPUT_HEATMAP, true);
    */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    //input_heatmap = (const double*)ssGetInputPortSignal(S,INPUT_HEATMAP);
