...
static void c4_emlrt_marshallIn(SFc4_falter_libraryInstanceStruct *chartInstance,
  const mxArray *c4_Dt, const char_T *c4_identifier, real_T c4_y[192]);
  ...
  (SFc4_falter_libraryInstanceStruct *chartInstance)
{
  ...
  real_T (*c4_Dt)[192];
  c4_Dt = (real_T (*)[192])ssGetOutputPortSignal(chartInstance->S, 1);
  c4_st = NULL;
  c4_st = NULL;
  c4_y = NULL;
  sf_mex_assign(&c4_y, sf_mex_createcellarray(2), FALSE);
  for (c4_i0 = 0; c4_i0 < 192; c4_i0++) {
    c4_u[c4_i0] = (*c4_Dt)[c4_i0];
  }

  c4_b_y = NULL;
  sf_mex_assign(&c4_b_y, sf_mex_create("y", c4_u, 0, 0U, 1U, 0U, 1, 192), FALSE);
  ...
  *chartInstance)
{
  ...
  int32_T c4_i15;
  real_T (*c4_b_Dt)[192];
  real_T (*c4_b_Directions)[576];
  real_T (*c4_b_Position)[3];
  real_T (*c4_b_Plane)[6];
  c4_b_Directions = (real_T (*)[576])ssGetInputPortSignal(chartInstance->S, 2);
  c4_b_Position = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 1);
  c4_b_Dt = (real_T (*)[192])ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  while (c4_b_i < 192) {
    ...
    c4_Dt[(int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("Dt", (int32_T)
      _SFD_INTEGER_CHECK("i", c4_i), 1, 192, 1, 0) - 1] = c4_y;
    c4_b_i++;
  ...
  for (c4_i15 = 0; c4_i15 < 192; c4_i15++) {
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  for (c4_i16 = 0; c4_i16 < 192; c4_i16++) {
    c4_b_inData[c4_i16] = (*(real_T (*)[192])c4_inData)[c4_i16];
  }

  for (c4_i17 = 0; c4_i17 < 192; c4_i17++) {
    c4_u[c4_i17] = c4_b_inData[c4_i17];
  }

  c4_y = NULL;
  sf_mex_assign(&c4_y, sf_mex_create("y", c4_u, 0, 0U, 1U, 0U, 1, 192), FALSE);
  ...
  real_T c4_y[192])
{
  real_T c4_dv1[192];
  int32_T c4_i18;
  sf_mex_import(c4_parentId, sf_mex_dup(c4_u), c4_dv1, 1, 0, 0U, 1, 0U, 1, 192);
  for (c4_i18 = 0; c4_i18 < 192; c4_i18++) {
  ...
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData)
{
  ...
  c4_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c4_Dt), &c4_thisId, c4_y);
  sf_mex_destroy(&c4_Dt);
  for (c4_i19 = 0; c4_i19 < 192; c4_i19++) {
    (*(real_T (*)[192])c4_outData)[c4_i19] = c4_y[c4_i19];
  }
  ...
  *c4_inData)
{
  ...
  c4_mxArrayOutData = NULL;
  c4_i20 = 0;
  for (c4_i21 = 0; c4_i21 < 192; c4_i21++) {
    for (c4_i22 = 0; c4_i22 < 3; c4_i22++) {
      c4_b_inData[c4_i22 + c4_i20] = (*(real_T (*)[576])c4_inData)[c4_i22 +
        c4_i20];
    }
  ...
  c4_i23 = 0;
  for (c4_i24 = 0; c4_i24 < 192; c4_i24++) {
  ...
  c4_y = NULL;
  sf_mex_assign(&c4_y, sf_mex_create("y", c4_u, 0, 0U, 1U, 0U, 2, 3, 192), FALSE);
  sf_mex_assign(&c4_mxArrayOutData, c4_y, FALSE);
  return c4_mxArrayOutData;
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2112894953U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(456690894U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1481582905U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(843664523U);
}
...
mxArray *sf_c4_falter_library_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("22Dvvwe19I7nPVqX4KGpdE");
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          real_T (*c4_Position)[3];
          real_T (*c4_Directions)[576];
          c4_Directions = (real_T (*)[576])ssGetInputPortSignal(chartInstance->S,
            2);
...
static void mdlSetWorkWidths_c4_falter_library(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1612596669U));
  ssSetChecksum1(S,(1610407665U));
  ssSetChecksum2(S,(1462144903U));
  ssSetChecksum3(S,(258878133U));
