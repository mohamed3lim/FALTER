...
static void c1_emlrt_marshallIn(SFc1_falter_libraryInstanceStruct *chartInstance,
  const mxArray *c1_D, const char_T *c1_identifier, real_T c1_y[768]);
  ...
  (SFc1_falter_libraryInstanceStruct *chartInstance)
{
  ...
  real_T (*c1_D)[768];
  c1_D = (real_T (*)[768])ssGetOutputPortSignal(chartInstance->S, 1);
  c1_st = NULL;
  c1_st = NULL;
  c1_y = NULL;
  sf_mex_assign(&c1_y, sf_mex_createcellarray(2), FALSE);
  for (c1_i0 = 0; c1_i0 < 768; c1_i0++) {
    c1_u[c1_i0] = (*c1_D)[c1_i0];
  }

  c1_b_y = NULL;
  sf_mex_assign(&c1_b_y, sf_mex_create("y", c1_u, 0, 0U, 1U, 0U, 1, 768), FALSE);
  ...
  *chartInstance)
{
  ...
  int32_T c1_i13;
  real_T (*c1_b_D)[768];
  real_T (*c1_b_Directions)[2304];
  real_T (*c1_b_Plane)[6];
  c1_b_Directions = (real_T (*)[2304])ssGetInputPortSignal(chartInstance->S, 1);
  c1_b_D = (real_T (*)[768])ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  for (c1_i3 = 0; c1_i3 < 768; c1_i3++) {
    _SFD_DATA_RANGE_CHECK((*c1_b_D)[c1_i3], 1U);
  }

  for (c1_i4 = 0; c1_i4 < 2304; c1_i4++) {
  ...
  while (c1_b_i < 768) {
    ...
    c1_c_i = (int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("Directions", (int32_T)
      _SFD_INTEGER_CHECK("i", c1_i), 1, 768, 2, 0) - 1;
    c1_i8 = 0;
    ...
    c1_D[(int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("D", (int32_T)
      _SFD_INTEGER_CHECK("i", c1_i), 1, 768, 1, 0) - 1] = c1_y;
    c1_b_i++;
  ...
  for (c1_i13 = 0; c1_i13 < 768; c1_i13++) {
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  for (c1_i14 = 0; c1_i14 < 768; c1_i14++) {
    c1_b_inData[c1_i14] = (*(real_T (*)[768])c1_inData)[c1_i14];
  }

  for (c1_i15 = 0; c1_i15 < 768; c1_i15++) {
    c1_u[c1_i15] = c1_b_inData[c1_i15];
  }

  c1_y = NULL;
  sf_mex_assign(&c1_y, sf_mex_create("y", c1_u, 0, 0U, 1U, 0U, 1, 768), FALSE);
  ...
  real_T c1_y[768])
{
  real_T c1_dv1[768];
  int32_T c1_i16;
  sf_mex_import(c1_parentId, sf_mex_dup(c1_u), c1_dv1, 1, 0, 0U, 1, 0U, 1, 768);
  for (c1_i16 = 0; c1_i16 < 768; c1_i16++) {
  ...
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  ...
  c1_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c1_D), &c1_thisId, c1_y);
  sf_mex_destroy(&c1_D);
  for (c1_i17 = 0; c1_i17 < 768; c1_i17++) {
    (*(real_T (*)[768])c1_outData)[c1_i17] = c1_y[c1_i17];
  }
  ...
  *c1_inData)
{
  ...
  c1_mxArrayOutData = NULL;
  c1_i18 = 0;
  for (c1_i19 = 0; c1_i19 < 768; c1_i19++) {
    for (c1_i20 = 0; c1_i20 < 3; c1_i20++) {
      c1_b_inData[c1_i20 + c1_i18] = (*(real_T (*)[2304])c1_inData)[c1_i20 +
        c1_i18];
    }
  ...
  c1_i21 = 0;
  for (c1_i22 = 0; c1_i22 < 768; c1_i22++) {
  ...
  c1_y = NULL;
  sf_mex_assign(&c1_y, sf_mex_create("y", c1_u, 0, 0U, 1U, 0U, 2, 3, 768), FALSE);
  sf_mex_assign(&c1_mxArrayOutData, c1_y, FALSE);
  return c1_mxArrayOutData;
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3262975151U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3519883750U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2781688501U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1098111546U);
}
...
mxArray *sf_c1_falter_library_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("E0HPVTjUtnOa8rAJmuFelF");
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          real_T (*c1_D)[768];
          real_T (*c1_Directions)[2304];
          c1_Directions = (real_T (*)[2304])ssGetInputPortSignal
            (chartInstance->S, 1);
          c1_D = (real_T (*)[768])ssGetOutputPortSignal(chartInstance->S, 1);
...
static void mdlSetWorkWidths_c1_falter_library(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(613861413U));
  ssSetChecksum1(S,(2893404128U));
  ssSetChecksum2(S,(693110435U));
  ssSetChecksum3(S,(2236339336U));
