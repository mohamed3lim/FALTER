...
MAKECMD         = /home/alim/MATLAB/MATLAB_Production_Server/R2013a/bin/glnxa64/gmake
HOST            = UNIX
BUILD           = yes
...
MODEL              = model_AllInOne
MODULES            = model_AllInOne_acc_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE           = model_AllInOne.mk
MATLAB_ROOT        = /home/alim/MATLAB/MATLAB_Production_Server/R2013a
ALT_MATLAB_ROOT    = /home/alim/MATLAB/MATLAB_Production_Server/R2013a
MASTER_ANCHOR_DIR  = 
START_DIR          = /home/alim/simulation
S_FUNCTIONS        = sf_sfun.c checkForZeroWall.c minSensorResults.c control.cpp
S_FUNCTIONS_LIB    = $(MATLAB_ROOT)/bin/glnxa64/libmwblas.so
SOLVER             = 
NUMST              = 7
TID01EQ            = 0
NCSTATES           = 23
...
ADD_INCLUDES = \
	-I$(MATLAB_ROOT)/extern/include \
	-I$(START_DIR)/slprj/accel/model_AllInOne \
	-I$(START_DIR) \
	-I$(START_DIR)/simulation/environment \
